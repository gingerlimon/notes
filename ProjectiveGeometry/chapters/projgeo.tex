...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \tkzDrawLine[white](A,B')
    \tkzDrawLine[white](A,C')
    \tkzDrawLine[white](B,A')
    \tkzDrawLine[white](B,C')
    \tkzDrawLine[white](C,B')
    \tkzDrawLine[white](C,A')
  ...
  \end{tikzpicture}
  \caption{When the conic is an ellipse.}
\end{figure}
