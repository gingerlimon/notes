...
General statement for the Theorem~\ref{thm:fundprojgeo} taken from \cite{shiri}.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \tkzDefPoint(1.13,0){P}
    \tkzDefPoint(-1.13,0){R}
    \tkzDrawEllipse[line width=1, white](Q,3,2,0)
    \tkzDrawPoints[fill=white](A,B,C,A',B',C',P,Q,R)
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \tkzDrawPoints[fill=white](E,P,Q,R,R')
    \tkzDrawLine[<->, line width=0.5, gray](y,y')
    \tkzDrawLine[<->, line width=0.5, gray](x,x')
    \tkzDrawLine[<->, line width=1, add=1.5 and 0.5,cyan](P,Q)
    \draw[domain=-2.1037979125:2.25, smooth, line width=1, white]
      plot (\x,{sqrt((\x)^3-3*\x+3))});
    \draw[domain=-2.1037979125:2.25, smooth, line width=1, white]
      plot (\x,{-sqrt((\x)^3-3*\x+3))});
    \tkzLabelPoints[above right, white](P)
    \tkzLabelPoints[above left, white](Q)
    \tkzLabelPoints[below right, white](R)
    \tkzLabelPoints[above right, white](R')
  \end{tikzpicture}
