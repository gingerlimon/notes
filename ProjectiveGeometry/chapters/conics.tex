    ...
    \item[(i)]{
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}
            ...
            \tkzDrawLine[<->, line width=1, add=0.2 and 0.2, white](P,Q)
            \tkzDrawLine[<->, line width=1, add=0.2 and 0.2, white](O,R)
            \tkzDrawCircle[color=white, line width=0.5](C,O)
            \tkzLabelPoints[below right, white](O)
    ...
    \item[(ii)]{
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}
            ...
            \tkzDrawPoints[fill=white](O,P,Q,R)
            \tkzDrawLine[<->, line width=1, add=0.2 and 0.2, white](P,Q)
            \tkzDrawLine[<->, line width=1, add=0.5 and 0.5, white](O,R)
            \tkzLabelPoints[below left, white](O)
            \tkzLabelPoints[above right, white](Q)
            \tkzLabelPoints[below left, white](P)
    ...
    \item[(iii)]{
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}
            ...
            \tkzDefPoint(-4,-0.25){R}
            \tkzDrawPoints[fill=white](O,P,Q,R)
            \tkzDrawLine[<->, line width=1, add=0.4 and 0.6, white](P,Q)
            \tkzDrawLine[<->, line width=1, add=0.4 and 0.2, white](O,R)
            \tkzLabelPoints[above right, white](O)
            \tkzLabelPoints[above, white](P)
            \tkzLabelPoints[below, white](R)
            \tkzLabelPoints[below left, white](Q)
          \end{tikzpicture}
