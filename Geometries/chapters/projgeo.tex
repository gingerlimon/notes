...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \tkzInterLL(A,C)(A',C')
       \tkzGetPoint{Q}
    \tkzDrawLine[line width=1, add=0 and 0, white](A,B)
    \tkzDrawLine[line width=0.5, add=0 and 0, white](B,R)
    \tkzDrawLine[line width=1, add=0 and 0, white](A',B')
    \tkzDrawLine[line width=0.5, add=0 and 0, white](B',R)
    \tkzDrawLine[line width=1, add=0 and 0, white](C,B)
    \tkzDrawLine[line width=0.5, add=0 and 0, white](B,P)
    \tkzDrawLine[line width=1, add=0 and 0, white](C',B')
    \tkzDrawLine[line width=0.5, add=0 and 0, white](B',P)
    \tkzDrawLine[line width=1, add=0 and 0, white](A,C)
    \tkzDrawLine[line width=0.5, add=0 and 0, white](C,Q)
    \tkzDrawLine[line width=1, add=0 and 0, white](A',C')
    \tkzDrawLine[line width=0.5, add=0 and 0, white](C',Q)
    \tkzDrawLine[line width=0.5, add=0 and 0.1, white](U,A')
    \tkzDrawLine[line width=0.5, add=0 and 0.5, white](U,B')
    \tkzDrawLine[line width=0.5, add=0 and 0.2, white](U,C')
    \tkzDrawLine[dashed, line width=0.5, add=0 and 0, white](P,Q)
    \tkzDrawPoints[fill=white](U,A,B,C,A',B',C',P,Q,R)
    \tkzLabelPoints[left, white](U)
    \tkzLabelPoints[above left, white](A)
    \tkzLabelPoints[above, white](A')
    \tkzLabelPoints[above, white](B)
    \tkzLabelPoints[above, white](B')
    \tkzLabelPoints[below left, white](C)
    \tkzLabelPoints[below right, white](C')
    \tkzLabelPoints[above, white](P)
    \tkzLabelPoints[below, white](Q)
    \tkzLabelPoints[below left, white](R)
  \end{scope}
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \tkzInterLL(C,B')(C',B)
       \tkzGetPoint{P}
    \tkzDrawEllipse[line width=0.5, white](O,3,2,0)
    \tkzDrawPoints[fill=pink](A,B,C,A',B',C',P,Q,R)
    \tkzDrawLine[white, add=0 and 0](A,B')
    \tkzDrawLine[white, add=0 and 0](A,C')
    \tkzDrawLine[white, add=0 and 0](B,A')
    \tkzDrawLine[white, add=0 and 0](B,C')
    \tkzDrawLine[white, add=0 and 0](C,B')
    \tkzDrawLine[white, add=0 and 0](C,A')
    \tkzDrawLine[dashed, add=0.5 and 0.5, white](P,R)
    \tkzLabelPoints[above right, white](P)
    \tkzLabelPoints[above, white](Q)
    \tkzLabelPoints[above left, white](R)
    \tkzLabelPoints[above left, white](A)
    \tkzLabelPoints[above, white](B)
    \tkzLabelPoints[above right, white](C)
    \tkzLabelPoints[below left, white](A')
    \tkzLabelPoints[below, white](B')
    \tkzLabelPoints[below right, white](C')
  \end{tikzpicture}
...
Proofs adapted from \cite{brannan}.
...
\begin{rmrk} \textbf{Formulas for cross-ratio}\\
...
\begin{defn}
  An elliptic curve is a non-empty, non-singular, degree 3 projective curve.
\end{defn}

\subsection{Weierstrass Standard Form}
The general equation for a cubic curve $C$ is,
\[
  ax^3+bx^2y+cxy^2+dy^3+ex^2+fxy+gy^2+hx+iy+j=0
\]
with atleast one of $a$, $b$, $c$, or $d$ nonzero. Assume that the underlying field is not of
charectestic $2$ or $3$.

If $C$ is nonsingular, it can be proved that it can be projectively transformed into the
\textit{Weirestrass form}:
\[
  y^2=x^3+Ax+B
\]
given, $4A^3+27B^2\ne 0$. It can also be proved that the point at infinity, usually taken as
$O$, is an inflection point. That is, $I_O(l,C)=3$, where $l$ is the tangent at infinity.

\subsection{Group Laws on Ellpitic Curves}

Similar to the group laws defined for conics in Chapter~\ref{chap:conics}, group law can also be defined
on elliptic curves.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \tkzDrawPoints[fill=pink, size=3](P,Q,O,s,s')
    \tkzDrawLine[<->, line width=0.5, add=0.5 and 1.5, cyan](P,Q)
    \tkzDrawLine[<->, line width=0.5, add=0.5 and 1.75, cyan](O,s)
    \draw[line width =0.5] (5,6) .. controls (3,0.5) .. (0,2)
                               .. controls (-3,3) and (-3,-3)  .. (0,-2)
                               .. controls (3,-0.5) .. (5,-6);
    \tkzLabelPoints[above left, white](P)
    \tkzLabelPoints[above, white](Q)
    \tkzLabelPoint[below right, white](s){$P\ast Q$}
    \tkzLabelPoint[above left, white](s'){$P+Q$}
    \tkzLabelPoints[above left, white](O)
    \end{scope}
  \end{tikzpicture}
