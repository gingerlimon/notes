...
Germinal Pierre Dandelin, a 19th century French-Belgian Mathematician, discovered this proof
...
\begin{theorem}
  Set of points of $C$ forms a group $\mathcal{G}(C)$ under the binary operation $\oplus$.
\end{theorem}
...
\begin{proof}
  ...
  parabolae are affine congruent to their respective standard forms. It will generalize our
  results to all conics.
